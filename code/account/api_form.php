    ...
    <h1>Настройки подключения к Redmine</h1>
      <form method="post" action="keep_api.php" >
          <label>
              ...
              <a href="<?php /*= url('account/acc_form') */?>">Личный кабинет</a><br>
              <a href="<?php /*= url('account/subscription/sub_form') */?>">Подписки</a><br>
              <a href="<?php /*= url('account/api_form') */?>">Настройки Redmine</a><br>
              <a href="<?php /*= url('auth/_sign-in_form') */?>">Выход</a><br>
          </label>
      </form>
</div>
</body>

...
<div class="option-window">
    ...
    <div class="account">
        <a href="<?= url('account/_score_form') ?>" class="account-text">Страница счета</a>
    </div>
    <div class="account">
        <a href="<?= url('account/api_form') ?>" class="account-text"> Redmine</a>
    </div>
    <div class="account">
...
<div class="container subscription-window">
    <svg class="photo-logo photo-sub" width="640" height="640" viewBox="0 0 640 640" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <p class="head head-sub">
        Оформление подписки
    </p>
    <ul class="list">
        <li class="list-blank">
            <input class="text-block text-block-sub" type="email" placeholder="...">
    ...
    <a href="#" class="bottom-reg bottom-sub">
        <p class="text-bottom">Оформить подписку</p>
    </a>
</div>
</body>
</html>
